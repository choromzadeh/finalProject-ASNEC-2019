...
workBookDataSet = load_workbook("airports.xlsx")

sheetDataSet = workBookDataSet['airports']
...
for x in range(1,12000):
    nodesSheet['A' + str(x)] = sheetDataSet['A' + str(x)].value



nodesWorkBook.save('S2-nodes.xlsx')
SourceEdges = []
TargetEdges = []
